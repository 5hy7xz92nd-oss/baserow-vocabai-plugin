...
alias test_clt_debug='${DOCKER_BASEROW_EXECUTE_BASH} "CLOUDLANGUAGETOOLS_CORE_TEST_SERVICES=yes pytest /baserow/data/plugins/baserow_vocabai_plugin/backend/tests -s --log-cli-level=DEBUG -k test_language_data"'